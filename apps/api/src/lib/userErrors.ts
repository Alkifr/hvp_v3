...
export const UserMsg = {
  ...
  INVALID_PG_IDENT: "Некорректное имя роли базы данных",
...
const CODE_STATUS: Partial<Record<UserErrorCode, number>> = {
  ...
  WRITE_BLOCKED: 403,
  DB_ROLE_PROVISION_FAILED: 400,
  INVALID_PG_IDENT: 400,
...
const ENGLISH_TO_CODE: Array<{ pattern: RegExp; code: UserErrorCode }> = [
  ...
  { pattern: /^announcement not found$/i, code: "ANNOUNCEMENT_NOT_FOUND" },
...
const FIELD_LABELS: Record<string, string> = {
  ...
  mutedNotificationKinds: "Уведомления",
  password: "Пароль",
