...
- Визуализация:
  ...
  - Таблица событий с inline-редактированием и настраиваемыми столбцами
  - Drag&Drop (в т.ч. массовый) с отдельной зоной drop и автопрокруткой
  - Схема ангара (план‑вид) с подсветкой занятости мест и быстрым резервированием
- Песочницы: сценарии «что если», перенос в прод, слияние песочниц с lineage
